...
for i in range(len(gradient_colors) * 2):
   ...
   /   | ____ _____/ (_)____/ /_     /_  __/___  ____  / /
  / /| |/ __ `/ __  / / ___/ __ \     / / / __ \/ __ \/ / 
 / ___ / /_/ / /_/ / (__  ) / / /    / / / /_/ / /_/ / /  
/_/  |_\__,_/\__,_/_/____/_/ /_/    /_/  \____/\____/_/   
                                                          
''')
        print(Fore.CYAN + Style.BRIGHT + '''             Aadish Tool : ) | YouTube Aadish GamerX| discord.gg/Aadishgamerx
